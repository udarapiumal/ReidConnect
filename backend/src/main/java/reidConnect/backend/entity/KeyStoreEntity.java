...
//        System.out.println("🔍 Setting publicKey - length: " + (publicKey != null ? publicKey.length() : "null"));
...
//        System.out.println("🔍 Setting privateKey - length: " + (privateKey != null ? privateKey.length() : "null"));
//        if (privateKey != null && privateKey.length() > 20) {
//            System.out.println("🔍 Setting privateKey - preview: " + privateKey.substring(0, 20) + "...");
//        } else {
