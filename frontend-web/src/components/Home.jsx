  ...
  useEffect(() => {
    const fetchLectures = async () => {
      try {
        ...
        const response = await fetch(`https://reidconnect-api.duckdns.org/api/timetable/byDay?day=${today}`);
    ...
    const fetchCurrentPeriod = async () => {
      try {
        const res = await fetch('https://reidconnect-api.duckdns.org/api/academic-calendar/current');
