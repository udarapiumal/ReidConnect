...
function LostItemsGallery() {
  ...
  useEffect(() => {
    const fetchLostItems = async () => {
      try {
        ...
        const response = await axios.get("https://reidconnect-api.duckdns.org/lost/lost-items", {
  ...
  try {
    const token = localStorage.getItem("token");
    await axios.delete(`https://reidconnect-api.duckdns.org/lost/lost-items/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
